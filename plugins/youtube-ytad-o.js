...
let msg = await conn.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/T1DqdYz/thumbnail.jpg' }, caption: capt, footer: '_*Whatsapp bot 💖 Dinuwa Official²⁰²³ 💖 *_', buttons }, { quoted: m })
}
